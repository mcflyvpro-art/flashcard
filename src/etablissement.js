...
import {
  auth, menu, prefs, prof, ref, school, setAnimate, view
} from './data/etat.js';
import { go, render } from './bibliotheque.js';
import { initial, profBilan } from './bilan-devoirs.js';
import { PAGE_REF, ROLENOM, dueLabel } from './classement.js';
import { api, esc, plur } from './coeur-sync.js';
import { toast } from './import-cartes.js';
import { paintMenu } from './menus-a.js';
